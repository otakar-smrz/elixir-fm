...
cluster_2   = cluster
 ...
 |> "b l .g" <| [
    ...
    FACiL                     `adj`     {- <bAli.g> -}         [ ['s','e','r','i','o','u','s'], ['c','r','i','t','i','c','a','l'], ['e','x','t','r','e','m','e'], ['p','r','o','f','o','u','n','d'] ],

    MuFaCCiL                  `noun`    {- <muballi.g> -}      [ ['i','n','f','o','r','m','e','r'] ]
                              `plural`     MuFaCCiL |< Un
                              `femini`     MuFaCCiL |< aT,

    MuFaCCiL                  `adj`     {- <muballi.g> -}      [ ['a','n','n','o','u','n','c','i','n','g'] ],
...
cluster_5   = cluster
 ...
 |> ['b','U','l','I','f'] <| [
    ...
    _____ |< iyA              `xtra`    {- <bUlIfiyA> -}       [ ['B','o','l','i','v','i','a'] ],
...
cluster_11  = cluster
 ...
 |> ['b','U','l','a','n','d'] <| [
    ...
    _____ |<< "A"             `xtra`    {- <bUlandA> -}        [ ['P','o','l','a','n','d'] ],
...
cluster_17  = cluster
 ...
 |> ['b','i','l','^','g','I','k'] <| [
    ...
    _____ |<< "A"             `xtra`    {- <bil^gIkA> -}       [ ['B','e','l','g','i','u','m'] ],
...
cluster_19  = cluster
 ...
 |> ['b','u','l','.','g','A','r'] <| [
    ...
    _____ |< iyA              `xtra`    {- <bul.gAriyA> -}     [ ['B','u','l','g','a','r','i','a'] ] ]
...
cluster_26  = cluster
 ...
 |> "b l .t" <| [
    ...
    FaCL |<< "a" |<< "^g" |< Iy `noun`    {- <bal.ta^gIy> -}     [ ['r','u','f','f','i','a','n'] ],
...
cluster_28  = cluster
 ...
 |> ['b','I','l','h','A','r','s'] <| [
    ...
    _____ |< iyA              `noun`    {- <bIlhArsiyA> -}     [ ['b','i','l','h','a','r','z','i','a'], ['s','c','h','i','s','t','o','s','o','m','i','a','s','i','s'] ] ]
...
cluster_29  = cluster
 ...
 |> ['b','i','m'] <| [
    ...
    _____ |<< "bA^s" |< Iy    `noun`    {- <bimbA^sIy> -}      [ unwords [ ['l','i','e','u','t','e','n','a','n','t'], ['c','o','l','o','n','e','l'] ] ] ]
...
cluster_32  = cluster
 ...
 |> ['b','a','m','b'] <| [
    ...
    _____ |< aT               `noun`    {- <bambaT> -}         [ unwords [ ['h','o','t'], ['p','i','n','k'] ] ],

    _____ |< Iy               `adj`     {- <bambIy> -}         [ unwords [ ['h','o','t'], ['p','i','n','k'] ] ] ]
...
cluster_47  = cluster
 ...
 |> "b n k" <| [
    ...
    MuFaCCaL                  `adj`     {- <mubannak> -}       [ ['s','t','r','a','n','d','e','d'], ['s','h','r','e','w','d'] ] ]
...
cluster_49  = cluster
 ...
 |> ['b','A','n','a','m'] <| [
    ...
    _____ |<< "A"             `xtra`    {- <bAnamA> -}         [ ['P','a','n','a','m','a'] ],

    _____ |<< "A'" |< Iy      `adj`     {- <bAnamA'Iy> -}      [ ['P','a','n','a','m','a','n','i','a','n'] ] ]
...
cluster_51  = cluster
 ...
 |> ['b','a','n','^','g','A','b'] <| [
    ...
    _____                     `xtra`    {- <ban^gAb> -}        [ ['P','u','n','j','a','b'] ],
...
cluster_52  = cluster
 ...
 |> ['b','a','n','^','g','A','l'] <| [
    ...
    _____                     `xtra`    {- <ban^gAl> -}        [ ['B','e','n','g','a','l'] ],
...
cluster_53  = cluster
 ...
 |> ['b','a','n','^','g','l','A','d','I','^','s'] <| [
    ...
    _____                     `xtra`    {- <ban^glAdI^s> -}    [ ['B','a','n','g','l','a','d','e','s','h'] ],
...
cluster_59  = cluster
 ...
 |> ['b','i','n','s','i','l','f','A','n'] <| [
    ...
    _____ |< iyA              `xtra`    {- <binsilfAniyA> -}   [ ['P','e','n','n','s','y','l','v','a','n','i','a'] ],
...
cluster_63  = cluster
 ...
 |> ['b','a','n','.','g','A','l','U','r'] <| [
    ...
    _____                     `xtra`    {- <ban.gAlUr> -}      [ ['B','a','n','g','a','l','o','r','e'] ],
...
cluster_80  = cluster
 ...
 |> ['b','U','h','I','m'] <| [
    ...
    _____ |< iyA              `xtra`    {- <bUhImiyA> -}       [ ['B','o','h','e','m','i','a','n'] ],
...
cluster_84  = cluster
 ...
 |> ['b','r','U','t','i','s','t','A','n','t'] <| [
    ...
    _____ |< Iy               `adj`     {- <brUtistAntIy> -}   [ ['P','r','o','t','e','s','t','a','n','t'] ]
                              `plural`     _____,

    _____ |< Iy               `noun`    {- <brUtistAntIy> -}   [ ['P','r','o','t','e','s','t','a','n','t'] ]
                              `plural`     _____
                              `femini`     _____ |< Iy |< aT ]
...
cluster_85  = cluster
 ...
 |> ['b','r','U','t','U','k','U','l'] <| [
    ...
    _____                     `noun`    {- <brUtUkUl> -}       [ ['p','r','o','t','o','c','o','l'] ]
                              `plural`     _____ |< At,

    _____ |< Iy               `adj`     {- <brUtUkUlIy> -}     [ ['p','r','o','t','o','c','o','l'] ] ]
...
cluster_86  = cluster
 ...
 |> ['b','r','U','t','I','n'] <| [
    ...
    _____                     `noun`    {- <brUtIn> -}         [ ['p','r','o','t','e','i','n'] ]
                              `plural`     _____ |< At ]
...
cluster_88  = cluster
 ...
 |> ['b','r','U','^','g','r','A','m'] <| [
    ...
    _____                     `noun`    {- <brU^grAm> -}       [ ['p','r','o','g','r','a','m'] ] ]
...
cluster_89  = cluster
 ...
 |> ['b','r','U','^','s','I','h'] <| [
    ...
    _____                     `noun`    {- <brU^sIh> -}        [ ['b','r','o','c','h','u','r','e'], ['p','r','o','s','p','e','c','t','u','s'] ]
                              `plural`     _____ |< At ]
...
cluster_90  = cluster
 ...
 |> ['b','r','I','.','t','A','n'] <| [
    ...
    _____ |< iyA              `xtra`    {- <brI.tAniyA> -}     [ ['B','r','i','t','a','i','n'] ],

    _____ |< Iy               `adj`     {- <brI.tAnIy> -}      [ ['B','r','i','t','i','s','h'] ],

    _____ |< Iy               `noun`    {- <brI.tAnIy> -}      [ ['B','r','i','t','i','s','h'] ]
                              `plural`     _____ |< Iy |< Un
                              `femini`     _____ |< Iy |< aT ]
...
cluster_91  = cluster
 ...
 |> ['b','r','U','f'] <| [
    ...
    _____ |< aT               `noun`    {- <brUfaT> -}         [ ['t','e','s','t'], unwords [ ['t','r','i','a','l'], ['r','u','n'] ], ['p','r','o','o','f'] ] ]
...
cluster_92  = cluster
 ...
 |> ['b','r','U','f','i','s','U','r'] <| [
    ...
    _____                     `noun`    {- <brUfisUr> -}       [ ['p','r','o','f','e','s','s','o','r'] ] ]
...
cluster_93  = cluster
 ...
 |> ['b','r','U','l','I','t','A','r'] <| [
    ...
    _____ |< iyA              `noun`    {- <brUlItAriyA> -}    [ ['p','r','o','l','e','t','a','r','i','a','t'] ],

    _____ |< Iy               `adj`     {- <brUlItArIy> -}     [ ['p','r','o','l','e','t','a','r','i','a','n'] ] ]
...
cluster_94  = cluster
 ...
 |> ['b','s','I','k','U','l','U','^','g'] <| [
    ...
    _____ |< iyA              `noun`    {- <bsIkUlU^giyA> -}   [ ['p','s','y','c','h','o','l','o','g','y'] ],

    _____ |< Iy               `adj`     {- <bsIkUlU^gIy> -}    [ ['p','s','y','c','h','o','l','o','g','i','c','a','l'] ] ]
...
cluster_95  = cluster
 ...
 |> ['b','l','U','t','U','q','r','A','.','t'] <| [
    ...
    _____ |< Iy               `noun`    {- <blUtUqrA.tIy> -}   [ ['p','l','u','t','o','c','r','a','t'] ]
                              `plural`     _____ |< Iy |< Un
                              `femini`     _____ |< Iy |< aT,

    _____ |< Iy               `adj`     {- <blUtUqrA.tIy> -}   [ ['p','l','u','t','o','c','r','a','t','i','c'] ],

    _____ |< Iy |< aT         `noun`    {- <blUtUqrA.tIyaT> -} [ ['p','l','u','t','o','c','r','a','c','y'] ] ]
...
cluster_96  = cluster
 ...
 |> ['b','l','A','t','I','n'] <| [
    ...
    _____                     `noun`    {- <blAtIn> -}         [ ['p','l','a','t','i','n','u','m'] ] ]
...
cluster_97  = cluster
 ...
 |> ['b','l','U','t','U','n'] <| [
    ...
    _____ |< Iy               `adj`     {- <blUtUnIy> -}       [ ['p','l','u','t','o','n','i','u','m'] ] ]
...
cluster_98  = cluster
 ...
 |> ['b','l','A','t','U','h'] <| [
    ...
    _____                     `noun`    {- <blAtUh> -}         [ ['p','l','a','t','e','a','u'], ['s','t','a','g','e'] ]
                              `plural`     _____ |< At ]
