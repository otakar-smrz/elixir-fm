...
module Elixir.Data.Sunny.Complex.G (section) where
...
cluster_1   = cluster
 ...
 |> ".t w ^s" <| [
    ...
    FaCALI                    `noun`    {- <.tawA^sI> -}       [ ['e','u','n','u','c','h'], ['c','a','s','t','r','a','t','o'] ]
                              `plural`     FaCALI |< aT,
...
cluster_2   = cluster
 ...
 |> ".t w `" <| [
    ...
    TaFaCCuL                  `noun`    {- <ta.tawwu`> -}      [ ['v','o','l','u','n','t','a','r','i','n','e','s','s'], ['v','o','l','u','n','t','e','e','r','i','n','g'] ]
                              `plural`     TaFaCCuL |< At,
...
cluster_4   = cluster
 ...
 |> ".t w q" <| [
    ...
    FAL |< Iy |< aT           `noun`    {- <.tAqIyaT> -}       [ ['s','k','u','l','l','c','a','p'], unwords [ ['f','o','r','a','g','e'], ['c','a','p'] ] ]
                              `plural`     FaCALI
                              `plural`     FaCALIy,
...
cluster_5   = cluster
 ...
 |> ".t w l" <| [
    ...
    FAL |<< "a" |<< "mA"      `conj`    {- <.tAlamA> -}        [ unwords [ ['a','s'], ['l','o','n','g'], ['a','s'] ], unwords [ ['h','o','w'], ['o','f','t','e','n'] ] ],

    FaCIL                     `adj`     {- <.tawIl> -}         [ ['t','a','l','l'], ['l','o','n','g'], ['l','e','n','g','t','h','y'], ['e','x','t','e','n','s','i','v','e'] ]
                              `plural`     FiCAL,
    ...
    MuFaCCaL                  `adj`     {- <mu.tawwal> -}      [ ['e','l','a','b','o','r','a','t','e'], ['c','o','m','p','r','e','h','e','n','s','i','v','e'], ['d','e','t','a','i','l','e','d'] ],
...
cluster_7   = cluster
 ...
 |> ".t w y" <| [
    ...
    FaCY                      `verb`    {- <.tawY> -}          [ ['f','o','l','d'], ['w','r','a','p'] ]
                              `imperf`     FCI,
    ...
    MunFaCI                   `adj`     {- <mun.tawI> -}       [ ['w','i','t','h','d','r','a','w','n'], ['i','n','t','r','o','v','e','r','t','e','d'] ],
...
cluster_8   = cluster
 ...
 |> ".t y b" <| [
    ...
    FaCCiL |< At              `noun`    {- <.tayyibAt> -}      [ unwords [ ['p','l','e','a','s','a','n','t'], ['t','h','i','n','g','s'] ], unwords [ ['g','o','o','d'], ['t','h','i','n','g','s'] ] ]
                              `plural`     FaCCiL |< At
...
cluster_14  = cluster
 ...
 |> ['.','z','A','\''] <| [
    ...
    _____                     `noun`    {- <.zA'> -}           [ unwords [ ['Z','a','\''], "(", ['A','r','a','b','i','c'], ['l','e','t','t','e','r'], ")" ] ]
                              `plural`     _____ |< At ]
...
cluster_22  = cluster
 ...
 |> ['l','A','\'','i','k'] <| [
    ...
    _____ |< Iy |< aT         `noun`    {- <lA'ikIyaT> -}      [ ['s','e','c','u','l','a','r','i','s','m'] ],

    _____ |< Iy               `adj`     {- <lA'ikIy> -}        [ ['s','e','c','u','l','a','r'] ] ]
...
cluster_27  = cluster
 ...
 |> "l b b" <| [
    ...
    FaCL |<< "ay" |<< "ka"    `intj`    {- <labbayka> -}       [ unwords [ "I", ['h','a','v','e'], ['a','n','s','w','e','r','e','d'], ['Y','o','u','r'], ['c','a','l','l'], "!" ] ],
...
cluster_30  = cluster
 ...
 |> "l b y" <| [
    ...
    FaCCY                     `verb`    {- <labbY> -}          [ unwords [ ['c','o','m','p','l','y'], ['w','i','t','h'] ], unwords [ ['c','a','r','r','y'], ['o','u','t'] ], unwords [ ['r','e','s','p','o','n','d'], ['t','o'] ] ],
...
cluster_31  = cluster
 ...
 |> ['l','U','b','i','y','A'] <| [
    ...
    _____                     `noun`    {- <lUbiyA> -}         [ unwords [ ['g','r','e','e','n'], ['b','e','a','n','s'] ], unwords [ ['s','t','r','i','n','g'], ['b','e','a','n','s'] ] ] ]
...
cluster_32  = cluster
 ...
 |> "l t t" <| [
    ...
    FaCCAL                    `noun`    {- <lattAt> -}         [ ['c','h','a','t','t','e','r','b','o','x'], ['p','r','a','t','t','l','e','r'] ]
                              `plural`     FaCCAL |< Un
                              `femini`     FaCCAL |< aT ]
...
cluster_38  = cluster
 ...
 |> "l .h y" <| [
    ...
    FaCw                      `noun`    {- <la.hw> -}          [ ['i','n','s','u','l','t'], ['v','i','l','i','f','i','c','a','t','i','o','n'] ],
    ...
    MuFtaCI                   `adj`     {- <multa.hI> -}       [ ['b','e','a','r','d','e','d'] ] ]
...
cluster_40  = cluster
 ...
 |> ['l','i','d','d'] <| [
    ...
    al >| _____               `noun`    {- <al-lidd> -}        [ ['L','y','d','d','a'] ] ]
...
cluster_45  = cluster
 ...
 |> "l ^s y" <| [
    ...
    MutaFACI                  `adj`     {- <mutalA^sI> -}      [ ['d','i','s','a','p','p','e','a','r','i','n','g'], ['v','a','n','i','s','h','i','n','g'] ] ]
...
cluster_51  = cluster
 ...
 |> "l q w" <| [
    ...
    MaFCUL                    `adj`     {- <malqUw> -}         [ unwords [ ['s','u','f','f','e','r','i','n','g'], ['f','r','o','m'], ['f','a','c','i','a','l'], ['p','a','r','a','l','y','s','i','s'] ] ] ]
...
cluster_55  = cluster
 ...
 |> "l m m" <| [
    ...
    HaFaCL                    `verb`    {- <'alamm> -}         [ unwords [ ['b','e'], ['a','c','q','u','a','i','n','t','e','d'] ] ],
    ...
    FiCAL |<< "aN"            `noun`    {- <limAmaN> -}        [ ['o','c','c','a','s','i','o','n','a','l','l','y'], ['r','a','r','e','l','y'] ],
...
cluster_57  = cluster
 ...
 |> "l h w" <| [
    ...
    FaCA                      `verb`    {- <lahA> -}           [ ['p','l','a','y'], unwords [ ['b','e'], ['a','m','u','s','e','d'] ], ['r','e','n','o','u','n','c','e'] ]
                              `imperf`     FCU,
...
cluster_59  = cluster
 ...
 |> ['l','a','w'] <| [
    ...
    _____ |<< "lA"            `conj`    {- <lawlA> -}          [ unwords [ ['i','f'], ['n','o','t'] ] ] ]
...
cluster_64  = cluster
 ...
 |> "l w .h" <| [
    ...
    FaCL                      `noun`    {- <law.h> -}          [ ['b','o','a','r','d'], ['t','a','b','l','e','t'], ['b','l','a','c','k','b','o','a','r','d'], ['s','l','a','t','e'] ]
                              `plural`     HaFCAL
                              `plural`     HaFACIL,

    FaCL |< aT                `noun`    {- <law.haT> -}        [ ['b','o','a','r','d'], ['t','a','b','l','e','t'], ['p','a','i','n','t','i','n','g'], ['p','i','c','t','u','r','e'] ]
                              `plural`     FaCL |< At,
...
cluster_66  = cluster
 ...
 |> "l w z" <| [
    ...
    FaCL                      `noun`    {- <lawz> -}           [ ['a','l','m','o','n','d'], ['t','o','n','s','i','l'] ]
                              `plural`     FaCL |< At,
...
cluster_76  = cluster
 ...
 |> "l w n" <| [
    ...
    TaFCIL                    `noun`    {- <talwIn> -}         [ ['c','o','l','o','r','a','t','i','o','n'], ['c','o','l','o','r','i','n','g'], unwords [ ['s','h','a','d','e'], ['o','f'], ['c','o','l','o','r'] ], ['h','u','e'] ]
                              `plural`     TaFCIL |< At,
...
cluster_77  = cluster
 ...
 |> ['l','A','w','i','n'] <| [
    ...
    _____ |<< "^g" |< Iy      `adj`     {- <lAwin^gIy> -}      [ unwords [ ['b','a','t','h'], ['a','t','t','e','n','d','a','n','t'] ] ],

    _____ |<< "^g" |< Iy |< aT `noun`    {- <lAwin^gIyaT> -}    [ ['h','o','u','s','e','m','a','i','d'] ] ]
...
cluster_78  = cluster
 ...
 |> ['l','a','w','a','n','d'] <| [
    ...
    _____ |<< "A"             `noun`    {- <lawandA> -}        [ ['l','a','v','e','n','d','e','r'] ] ]
...
cluster_88  = cluster
 ...
 |> "l y l" <| [
    ...
    FaCL |< aT |<< "a" |<< "'i_diN" `adv`     {- <laylaTa'i_diN> -}  [ unwords [ ['o','n'], ['t','h','a','t'], ['n','i','g','h','t'] ] ],
...
cluster_96  = cluster
 ...
 |> "n b '" <| [
    ...
    FaCIy                     `noun`    {- <nabIy> -}          [ ['p','r','o','p','h','e','t'] ]
                              `plural`     FaCIy |< Un
                              `plural`     HaFCiyA'
                              `femini`     FaCIy |< aT,
