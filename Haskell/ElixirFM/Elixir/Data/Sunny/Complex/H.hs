...
cluster_7   = cluster
 ...
 |> "n d y" <| [
    ...
    HaFCY                     `verb`    {- <'andY> -}          [ ['m','o','i','s','t','e','n'], unwords [ ['m','a','k','e'], ['d','a','m','p'] ] ],
    ...
    FaCAw |< aT               `noun`    {- <nadAwaT> -}        [ ['m','o','i','s','t','n','e','s','s'], ['d','a','m','p','n','e','s','s'] ],

    FuCUw |< aT               `noun`    {- <nudUwaT> -}        [ ['m','o','i','s','t','n','e','s','s'], ['d','a','m','p','n','e','s','s'] ],

    FaCIL                     `adj`     {- <nadIy> -}          [ ['m','o','i','s','t'], ['d','a','m','p'], ['g','e','n','e','r','o','u','s'] ],

    FaCLAn                    `adj`     {- <nadyAn> -}         [ ['m','o','i','s','t'], ['d','a','m','p'], ['g','e','n','e','r','o','u','s'] ],

    FaCwAn                    `adj`     {- <nadwAn> -}         [ ['m','o','i','s','t'], ['d','a','m','p'], ['g','e','n','e','r','o','u','s'] ],
...
cluster_9   = cluster
 ...
 |> "n z z" <| [
    ...
    FaCL                      `adj`     {- <nazz> -}           [ ['s','w','i','f','t'], ['a','g','i','l','e'], ['f','i','c','k','l','e'] ],
...
cluster_13  = cluster
 ...
 |> "n s y" <| [
    ...
    FaCLAn                    `adj`     {- <nasyAn> -}         [ ['f','o','r','g','e','t','f','u','l'], ['o','b','l','i','v','i','o','u','s'] ],

    FiCLAn                    `noun`    {- <nisyAn> -}         [ ['f','o','r','g','e','t','f','u','l','n','e','s','s'], ['o','b','l','i','v','i','o','n'] ],

    FaCCA'                    `adj`     {- <nassA'> -}         [ ['f','o','r','g','e','t','f','u','l'], ['o','b','l','i','v','i','o','u','s'] ],
...
cluster_20  = cluster
 ...
 |> "n .d w" <| [
    ...
    FaCCY                     `verb`    {- <na.d.dY> -}        [ unwords [ ['t','a','k','e'], ['o','f','f'] ], ['s','t','r','i','p'] ],
...
cluster_25  = cluster
 ...
 |> "n f y" <| [
    ...
    FuCAL |< aT               `noun`    {- <nufAyaT> -}        [ ['w','a','s','t','e'], ['r','e','f','u','s','e'], ['r','e','m','a','i','n','s'] ]
                              `plural`     FuCAL |< At,

    FuCAw |< aT               `noun`    {- <nufAwaT> -}        [ ['r','e','f','u','s','e'], unwords [ ['d','i','s','c','a','r','d','e','d'], ['i','t','e','m'] ] ],
    ...
    FACI                      `adj`     {- <nAfI> -}           [ ['d','e','n','y','i','n','g'], ['d','i','s','a','v','o','w','i','n','g'], ['r','e','j','e','c','t','i','n','g'] ],
...
cluster_31  = cluster
 ...
 |> "n m y" <| [
    ...
    FaCCY                     `verb`    {- <nammY> -}          [ unwords [ ['m','a','k','e'], ['g','r','o','w'] ], ['a','d','v','a','n','c','e'] ],

    HaFCY                     `verb`    {- <'anmY> -}          [ unwords [ ['m','a','k','e'], ['g','r','o','w'] ], ['a','d','v','a','n','c','e'] ],
    ...
    FuCUw                     `noun`    {- <numUw> -}          [ ['d','e','v','e','l','o','p','m','e','n','t'], ['g','r','o','w','t','h'], ['p','r','o','g','r','e','s','s'] ],

    FaCA'                     `noun`    {- <namA'> -}          [ ['g','r','o','w','t','h'], ['a','c','c','r','e','t','i','o','n'] ],

    FaCL                      `noun`    {- <namy> -}           [ ['g','r','o','w','t','h'], ['a','c','c','r','e','t','i','o','n'] ],

    FaCIL                     `noun`    {- <namIy> -}          [ ['g','r','o','w','t','h'], ['a','c','c','r','e','t','i','o','n'] ],

    FaCY |< aT                `noun`    {- <namAT> -}          [ ['l','o','u','s','e'] ]
                              `plural`     FaCY,
    ...
    lA >| MuFtaCI             `adj`     {- <lA-muntamI> -}     [ unwords [ ['i','d','e','o','l','o','g','i','c','a','l','l','y'], ['i','n','d','e','p','e','n','d','e','n','t'] ] ],
...
cluster_33  = cluster
 ...
 |> "n h y" <| [
    ...
    FaCA                      `verb`    {- <nahA> -}           [ ['f','o','r','b','i','d'], ['r','e','s','t','r','a','i','n'] ]
                              `imperf`     FCU,

    FuCI                      `verb`    {- <nuhI> -}           [ ['r','e','a','c','h'], unwords [ ['b','e'], ['i','n','f','o','r','m','e','d'] ] ],
    ...
    FaCw                      `noun`    {- <nahw> -}           [ ['t','e','r','m','i','n','a','t','i','o','n'], ['c','o','n','c','l','u','s','i','o','n'] ],
    ...
    FiCAL |< aT               `noun`    {- <nihAyaT> -}        [ ['e','n','d'], ['t','e','r','m','i','n','a','t','i','o','n'] ]
                              `plural`     FiCAL |< At,

    FiCA' |< Iy               `adj`     {- <nihA'Iy> -}        [ ['f','i','n','a','l'], ['d','e','f','i','n','i','t','i','v','e'], ['c','o','n','c','l','u','s','i','v','e'], unwords [ ['i','n'], ['t','h','e'], ['e','n','d'] ] ],
    ...
    MuFtaCI                   `adj`     {- <muntahI> -}        [ ['f','i','n','i','s','h','e','d'], ['e','x','p','i','r','e','d'] ],

    MuFtaCY                   `adj`     {- <muntahY> -}        [ ['u','t','m','o','s','t'], ['e','x','t','r','e','m','e'], ['t','e','r','m','i','n','a','t','e','d'] ] ]
...
cluster_35  = cluster
 ...
 |> "n w b" <| [
    ...
    FaCL |< aT |<< "^g" |< Iy `adj`     {- <nawbaT^gIy> -}     [ unwords [ ['o','n'], ['d','u','t','y'] ], unwords [ ['o','n'], ['c','a','l','l'] ] ],

    FaCL |< aT |<< "^g" |< Iy |< aT `noun`    {- <nawbaT^gIyaT> -}   [ unwords [ ['s','h','i','f','t'], ['d','u','t','y'] ], unwords [ ['n','i','g','h','t'], ['d','u','t','y'] ] ],
    ...
    MuFIL                     `adj`     {- <munIb> -}          [ ['r','e','p','e','n','t','a','n','t'] ],
...
cluster_38  = cluster
 ...
 |> "n w .h" <| [
    ...
    FAL                       `verb`    {- <nA.h> -}           [ ['m','o','u','r','n'], ['l','a','m','e','n','t'] ]
                              `imperf`     FUL,
...
cluster_41  = cluster
 ...
 |> "n w r" <| [
    ...
    FuCCAL                    `noun`    {- <nuwwAr> -}         [ ['b','l','o','s','s','o','m'], ['f','l','o','w','e','r'] ]
                              `plural`     FaCACIL
                              `femini`     FuCCAL |< aT,
...
cluster_44  = cluster
 ...
 |> "n w ^s" <| [
    ...
    MaFACIL                   `adj`     {- <manAwI^s> -}       [ unwords [ ['b','l','u','i','s','h'], ['p','u','r','p','l','e'] ] ],
...
cluster_46  = cluster
 ...
 |> "n w .t" <| [
    ...
    HaFAL                     `verb`    {- <'anA.t> -}         [ ['e','n','t','r','u','s','t'], unwords [ ['m','a','k','e'], ['d','e','p','e','n','d','e','n','t'] ], unwords [ ['m','a','k','e'], ['c','o','n','d','i','t','i','o','n','a','l'] ] ],
...
cluster_47  = cluster
 ...
 |> "n w `" <| [
    ...
    TaFCIL                    `noun`    {- <tanwI`> -}         [ ['m','i','x','t','u','r','e'], ['m','i','s','c','e','l','l','a','n','y'] ]
                              `plural`     TaFCIL |< At,
    ...
    MutaFaCCiL |< At          `noun`    {- <mutanawwi`At> -}   [ ['m','i','s','c','e','l','l','a','n','y'], unwords [ ['d','i','v','e','r','s','e'], ['i','t','e','m','s'] ] ]
...
cluster_50  = cluster
 ...
 |> "n w l" <| [
    ...
    FaCLUn                    `noun`    {- <nawlUn> -}         [ ['f','r','e','i','g','h','t'], ['f','r','e','i','g','h','t','a','g','e'] ]
                              `plural`     FaCALIn,
    ...
    MutaFACiL                 `adj`     {- <mutanAwil> -}      [ unwords [ ['d','e','a','l','i','n','g'], ['w','i','t','h'] ], ['e','a','t','i','n','g'] ],

    MutaFACaL                 `adj`     {- <mutanAwal> -}      [ ['a','v','a','i','l','a','b','l','e'], unwords [ ['w','i','t','h','i','n'], ['r','e','a','c','h'] ] ],
...
cluster_51  = cluster
 ...
 |> "n w m" <| [
    ...
    HaFAL                     `verb`    {- <'anAm> -}          [ unwords [ ['m','a','k','e'], ['s','l','e','e','p'] ], unwords [ ['l','a','y'], ['d','o','w','n'] ], ['a','n','e','s','t','h','e','t','i','z','e'] ],
    ...
    MuFaCCiL                  `adj`     {- <munawwim> -}       [ unwords [ ['s','l','e','e','p'], "-", ['i','n','d','u','c','i','n','g'] ] ],
...
cluster_55  = cluster
 ...
 |> "n y '" <| [
    ...
    FIL                       `adj`     {- <nI'> -}            [ ['r','a','w'], ['u','n','c','o','o','k','e','d'] ],
...
cluster_56  = cluster
 ...
 |> "n y b" <| [
    ...
    FAL                       `noun`    {- <nAb> -}            [ unwords [ ['c','a','n','i','n','e'], ['t','o','o','t','h'] ], ['f','a','n','g'], ['t','u','s','k'] ]
                              `plural`     HaFCAL
                              `plural`     HaFACIL
                              `plural`     FuCUL,
...
cluster_59  = cluster
 ...
 |> ['n','i','y','U','z','I','l','A','n','d'] <| [
    ...
    _____ |<< "A"             `xtra`    {- <niyUzIlAndA> -}    [ unwords [ ['N','e','w'], ['Z','e','a','l','a','n','d'] ] ],

    _____ |< Iy               `adj`     {- <niyUzIlAndIy> -}   [ unwords [ ['N','e','w'], ['Z','e','a','l','a','n','d','e','r'] ] ] ]
...
cluster_63  = cluster
 ...
 |> "n y k" <| [
    ...
    FIL |< aT                 `noun`    {- <nIkaT> -}          [ unwords [ ['h','a','v','i','n','g'], ['s','e','x'] ] ],

    MaFCaL                    `noun`    {- <manyak> -}         [ ['f','u','c','k','e','r'] ]
                              `plural`     MaFACiL,

    MaFCUL                    `adj`     {- <manyUk> -}         [ ['f','u','c','k','e','d'] ] ]
...
cluster_65  = cluster
 ...
 |> ['n','i','y','U','y','U','r','k'] <| [
    ...
    _____ |< Iy               `adj`     {- <niyUyUrkIy> -}     [ unwords [ ['N','e','w'], ['Y','o','r','k','e','r'] ] ] ]
...
cluster_66  = cluster
 ...
 |> ['n','a','y','^','g','a','r'] <| [
    ...
    _____                     `xtra`    {- <nay^gar> -}        [ ['N','i','g','e','r'] ] ]

 |> ['n','a','y','^','g','I','r'] <| [

    _____ |< iyA              `xtra`    {- <nay^gIriyA> -}     [ ['N','i','g','e','r','i','a'] ],
