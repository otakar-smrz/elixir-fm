...
cluster_9   = cluster
 ...
 |> ".t r q" <| [
    ...
    FuCL |< aT                `noun`    {- <.turqaT> -}        [ ['r','o','a','d'], ['p','a','s','s','a','g','e'] ],

    FaCIL |< aT               `noun`    {- <.tarIqaT> -}       [ ['m','e','t','h','o','d'], ['p','r','o','c','e','d','u','r','e'], ['m','a','n','n','e','r','s'] ]
                              `plural`     FaCA'iL
                              `plural`     FuCuL,

    FaCIL |< aT               `noun`    {- <.tarIqaT> -}       [ unwords [ ['r','e','l','i','g','i','o','u','s'], ['b','r','o','t','h','e','r','h','o','o','d'] ], unwords [ ['d','e','r','v','i','s','h'], ['o','r','d','e','r'] ] ]
                              `plural`     FuCuL,
    ...
    MiFCAL                    `adj`     {- <mi.trAq> -}        [ ['v','e','r','s','a','t','i','l','e'], unwords [ ['m','a','n','y'], "-", ['s','i','d','e','d'] ] ],
...
cluster_19  = cluster
 ...
 |> ".t z h" <| [
    ...
    FACaL                     `adj`     {- <.tAzah> -}         [ ['f','r','e','s','h'], ['t','e','n','d','e','r'] ] ]
...
cluster_33  = cluster
 ...
 |> ".t f l" <| [
    ...
    FaCAL |< aT               `noun`    {- <.tafAlaT> -}       [ ['c','h','i','l','d','h','o','o','d'], ['i','n','f','a','n','c','y'] ],

    FuCUL |< aT               `noun`    {- <.tufUlaT> -}       [ ['c','h','i','l','d','h','o','o','d'], ['i','n','f','a','n','c','y'] ],
...
cluster_37  = cluster
 ...
 |> ".t l b" <| [
    ...
    MuFACiL                   `noun`    {- <mu.tAlib> -}       [ ['c','l','a','i','m','a','n','t'] ]
                              `plural`     MuFACiL |< Un
                              `femini`     MuFACiL |< aT,
...
cluster_41  = cluster
 ...
 |> ".t l `" <| [
    ...
    TaFaCCuL                  `noun`    {- <ta.tallu`> -}      [ ['e','n','d','e','a','v','o','r'], ['a','s','p','i','r','a','t','i','o','n'], ['h','o','p','e'] ]
                              `plural`     TaFaCCuL |< At,
...
cluster_42  = cluster
 ...
 |> ".t l q" <| [
    ...
    InFiCAL                   `noun`    {- <in.tilAq> -}       [ ['d','e','p','a','r','t','u','r','e'], ['r','e','l','e','a','s','e'] ]
                              `plural`     InFiCAL |< At,
    ...
    MuFCaL                    `adj`     {- <mu.tlaq> -}        [ ['a','b','s','o','l','u','t','e'], ['u','n','l','i','m','i','t','e','d'] ],
...
cluster_47  = cluster
 ...
 |> ".t m _t" <| [
    ...
    FACiL                     `adj`     {- <.tAmi_t> -}        [ ['m','e','n','s','t','r','u','a','t','i','n','g'] ] ]
...
cluster_49  = cluster
 ...
 |> ".t m r" <| [
    ...
    MiFCaL                    `noun`    {- <mi.tmar> -}        [ unwords [ ['p','l','u','m','b'], ['l','i','n','e'] ], unwords [ ['u','n','d','e','r','g','r','o','u','n','d'], ['g','r','a','n','a','r','y'] ] ]
                              `plural`     MaFACiL,
...
cluster_51  = cluster
 ...
 |> ".t m .t m" <| [
    ...
    KaRADiS                   `noun`    {- <.tamA.tim> -}      [ ['t','o','m','a','t','o'] ]
                              `plural`     KaRADiS
                           
    `limited` "-------P--",

    KuRDuSAn |< Iy            `adj`     {- <.tum.tumAnIy> -}   [ ['u','n','e','d','u','c','a','t','e','d'], ['b','a','r','b','a','r','i','c'] ] ]
...
cluster_60  = cluster
 ...
 |> ".t n .t" <| [
    ...
    FaCL |<< "A"              `noun`    {- <.tan.tA> -}        [ ['T','a','n','t','a'] ],

    FaCL |<< "Aw" |< Iy       `adj`     {- <.tan.tAwIy> -}     [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['T','a','n','t','a'] ] ],

    FaCL |<< "Aw" |< Iy       `noun`    {- <.tan.tAwIy> -}     [ ['T','a','n','t','a','w','i'], ['T','a','n','t','a','o','u','i'] ] ]
...
cluster_75  = cluster
 ...
 |> ".z n b" <| [
    ...
    FuCLUL                    `noun`    {- <.zunbUb> -}        [ ['s','h','i','n','b','o','n','e'], ['t','i','b','i','a'] ]
                              `plural`     FaCALIL,

    FuCLUL |< Iy              `adj`     {- <.zunbUbIy> -}      [ ['t','i','b','i','a','l'], ['s','h','i','n'] ] ]
...
cluster_76  = cluster
 ...
 |> ".z h r" <| [
    ...
    FuCL                      `noun`    {- <.zuhr> -}          [ ['n','o','o','n'], ['a','f','t','e','r','n','o','o','n'] ]
                              `plural`     HaFCAL,
    ...
    MaFCaL                    `noun`    {- <ma.zhar> -}        [ ['a','p','p','e','a','r','a','n','c','e'], ['f','a','c','a','d','e'], ['f','e','a','t','u','r','e'], ['m','a','n','i','f','e','s','t','a','t','i','o','n'] ]
                              `plural`     MaFACiL,
...
cluster_77  = cluster
 ...
 |> ['l','i'] <| [
    ...
    _____                     `part`    {- <li> -}             [ ['l','e','t'], ['d','o'] ],

    _____ |<< "_dA"           `conj`    {- <li_dA> -}          [ ['t','h','e','r','e','f','o','r','e'] ],

    _____ |<< "_d_alika"      `conj`    {- <li_d_alika> -}     [ ['t','h','e','r','e','f','o','r','e'] ],

    _____ |<< "mA_dA"         `pron`    {- <limA_dA> -}        [ ['w','h','y'] ],

    _____ |<< "mA"            `pron`    {- <limA> -}           [ ['w','h','y'] ],
...
cluster_79  = cluster
 ...
 |> ['l','I','b'] <| [
    ...
    _____ |< iyA              `xtra`    {- <lIbiyA> -}         [ ['L','i','b','y','a'] ],
...
cluster_85  = cluster
 ...
 |> ['l','I','b','I','r'] <| [
    ...
    _____ |< iyA              `xtra`    {- <lIbIriyA> -}       [ ['L','i','b','e','r','i','a'] ],
...
cluster_87  = cluster
 ...
 |> "l b s" <| [
    ...
    FaCCIL |< aT              `noun`    {- <labbIsaT> -}       [ ['s','h','o','e','h','o','r','n'] ],
    ...
    MutaFaCCiL                `adj`     {- <mutalabbis> -}     [ unwords [ ['i','n'], ['f','l','a','g','r','a','n','t','e'], ['d','e','l','i','c','t','o'] ], unwords [ ['r','e','d'], "-", ['h','a','n','d','e','d'] ] ],
...
cluster_90  = cluster
 ...
 |> "l b k" <| [
    ...
    FaCaL                     `verb`    {- <labak> -}          [ ['m','i','x'], ['m','u','d','d','l','e'] ]
                              `imperf`     FCuL,

    FaCiL                     `verb`    {- <labik> -}          [ unwords [ ['g','e','t'], ['c','o','n','f','u','s','e','d'] ], unwords [ ['b','e','c','o','m','e'], ['d','i','s','o','r','g','a','n','i','z','e','d'] ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- <labbak> -}         [ ['m','i','x'], ['m','u','d','d','l','e'] ],

    TaFaCCaL                  `verb`    {- <talabbak> -}       [ unwords [ ['g','e','t'], ['c','o','n','f','u','s','e','d'] ], unwords [ ['b','e','c','o','m','e'], ['d','i','s','o','r','g','a','n','i','z','e','d'] ] ],

    IFtaCaL                   `verb`    {- <iltabak> -}        [ unwords [ ['g','e','t'], ['c','o','n','f','u','s','e','d'] ], unwords [ ['b','e','c','o','m','e'], ['d','i','s','o','r','g','a','n','i','z','e','d'] ] ] ]
...
cluster_91  = cluster
 ...
 |> "l b l b" <| [
    ...
    KaRDaS                    `verb`    {- <lablab> -}         [ ['f','o','n','d','l','e'], ['c','a','r','e','s','s'] ],

    KaRDaS                    `noun`    {- <lablab> -}         [ ['a','f','f','e','c','t','i','o','n','a','t','e'], ['t','e','n','d','e','r'] ]
                              `plural`     KuRDuS |< aT,

    KaRDAS                    `noun`    {- <lablAb> -}         [ ['l','a','b','l','a','b'], unwords [ ['h','y','a','c','i','n','t','h'], ['b','e','a','n'] ], unwords [ ['E','n','g','l','i','s','h'], ['i','v','y'] ] ],

    KaRDUS                    `noun`    {- <lablUb> -}         [ ['s','p','r','o','u','t'], ['v','i','n','e'] ]
                              `plural`     KaRADIS ]
...
cluster_92  = cluster
 ...
 |> "l b n" <| [
    ...
    FaCCaL                    `verb`    {- <labban> -}         [ unwords [ ['m','a','k','e'], ['b','r','i','c','k'] ] ],

    IFtaCaL                   `verb`    {- <iltaban> -}        [ unwords [ ['s','u','c','k'], ['m','i','l','k'] ] ],

    FiCL                      `noun`    {- <libn> -}           [ unwords [ ['a','d','o','b','e'], ['b','r','i','c','k'] ] ]
                              `plural`     FiCL |< At
                              `plural`     FaCiL |< At,

    FiCL |< aT                `noun`    {- <libnaT> -}         [ ['c','h','e','e','s','e'] ]
                              `plural`     FaCiL |< At,

    FiCL |< At                `noun`    {- <libnAt> -}         [ unwords [ ['s','t','r','u','c','t','u','r','a','l'], ['u','n','i','t','s'] ] ]
                              `plural`     FiCL |< At
                           
    `limited` "-------P--",

    FaCaL                     `noun`    {- <laban> -}          [ ['m','i','l','k'], unwords [ ['c','u','r','d','l','e','d'], ['m','i','l','k'] ], ['l','a','b','a','n'], unwords [ ['d','a','i','r','y'], ['p','r','o','d','u','c','t','s'] ], unwords [ ['m','i','l','k'], ['p','r','o','d','u','c','t','s'] ] ]
                              `plural`     HaFCAL
                              `plural`     FiCAL,

    FaCaL |< Iy               `adj`     {- <labanIy> -}        [ ['l','a','c','t','i','c'], ['m','i','l','k'], unwords [ ['m','i','l','k'], "-", ['l','i','k','e'] ] ],

    FaCaL |< Iy |< aT         `noun`    {- <labanIyaT> -}      [ unwords [ ['l','a','b','a','n','i','y','a'], "(", ['m','i','l','k'], ['d','i','s','h'], ")" ] ],

    FaCaL |< At               `noun`    {- <labanAt> -}        [ ['l','a','c','t','a','t','e'] ]
                              `plural`     FaCaL |< At
                           
    `limited` "-------P--",

    FuCAL                     `noun`    {- <lubAn> -}          [ unwords [ ['c','h','e','w','i','n','g'], ['g','u','m'] ], ['f','r','a','n','k','i','n','c','e','n','s','e'] ],

    FiCAL                     `noun`    {- <libAn> -}          [ ['s','u','c','k','i','n','g'], ['n','u','r','s','i','n','g'] ],

    FaCCAL                    `noun`    {- <labbAn> -}         [ unwords [ ['b','r','i','c','k'], ['m','a','k','e','r'] ], ['m','i','l','k','m','a','n'] ]
                              `plural`     FaCCAL |< Un
                              `femini`     FaCCAL |< aT,

    FuCAL |< aT               `noun`    {- <lubAnaT> -}        [ ['e','n','t','e','r','p','r','i','s','e'], ['b','u','s','i','n','e','s','s'] ]
                              `plural`     FuCAL
                              `plural`     FuCAL |< At,

    FiCAL |< aT               `noun`    {- <libAnaT> -}        [ unwords [ ['d','a','i','r','y'], ['b','u','s','i','n','e','s','s'] ] ],

    FaCiL |< aT               `noun`    {- <labinaT> -}        [ ['m','i','l','c','h'], unwords [ ['g','i','v','i','n','g'], ['m','i','l','k'] ] ]
                              `plural`     FaCUL |< aT
                              `plural`     FuCL
                              `plural`     FiCAL
                              `plural`     FaCA'iL,

    FaCUL                     `noun`    {- <labUn> -}          [ ['m','a','m','m','a','l'] ],

    FuCLY                     `noun`    {- <lubnY> -}          [ unwords [ ['s','t','o','r','a','x'], ['t','r','e','e'] ] ],

    FuCLY                     `noun`    {- <lubnY> -}          [ ['L','u','b','n','a'] ],

    MaFCaL                    `noun`    {- <malban> -}         [ unwords [ ['m','a','l','b','a','n'], "(", ['s','w','e','e','t'], ")" ] ],

    MaFCaL |< aT              `noun`    {- <malbanaT> -}       [ ['d','a','i','r','y'] ] ]

 |> ['l','u','b','n','A','n'] <| [

    _____ |< Iy               `noun`    {- <lubnAnIy> -}       [ ['L','e','b','a','n','e','s','e'] ]
                              `plural`     _____ |< Iy |< Un
                              `femini`     _____ |< Iy |< aT,

    _____ |< Iy               `adj`     {- <lubnAnIy> -}       [ ['L','e','b','a','n','e','s','e'] ],

    _____                     `noun`    {- <lubnAn> -}         [ ['L','e','b','a','n','o','n'] ] ]
...
cluster_93  = cluster
 ...
 |> ['l','I','t','u','r','^','g'] <| [
    ...
    _____ |< Iy |< aT         `noun`    {- <lItur^gIyaT> -}    [ ['l','i','t','u','r','g','y'] ]
                              `plural`     _____ |< Iy |< At ]
...
cluster_94  = cluster
 ...
 |> "l t m s" <| [
    ...
    KiRDUS                    `noun`    {- <litmUs> -}         [ ['l','i','t','m','u','s'] ] ]
...
cluster_95  = cluster
 ...
 |> ['l','A','t','I','n'] <| [
    ...
    _____ |< Iy               `adj`     {- <lAtInIy> -}        [ ['L','a','t','i','n'] ],

    _____ |< Iy |< aT         `noun`    {- <lAtInIyaT> -}      [ ['L','a','t','i','n'] ] ]
...
cluster_97  = cluster
 ...
 |> "l _t .g" <| [
    ...
    FaCiL                     `verb`    {- <la_ti.g> -}        [ ['l','i','s','p'], ['m','i','s','p','r','o','n','o','u','n','c','e'] ]
                              `imperf`     FCaL,

    FaCaL                     `noun`    {- <la_ta.g> -}        [ ['l','i','s','p'], ['m','i','s','p','r','o','n','u','n','c','i','a','t','i','o','n'] ],

    FuCL |< aT                `noun`    {- <lu_t.gaT> -}       [ ['l','i','s','p','i','n','g'] ],

    HaFCaL                    `adj`     {- <'al_ta.g> -}       [ ['l','i','s','p','e','r'] ]
                              `plural`     FuCL
                              `femini`     FaCLA' ]
...
cluster_98  = cluster
 ...
 |> "l _t m" <| [
    ...
    FaCaL                     `verb`    {- <la_tam> -}         [ ['k','i','s','s'], ['s','t','r','i','k','e'], ['i','n','j','u','r','e'] ]
                              `imperf`     FCiL,

    FaCCaL                    `verb`    {- <la_t_tam> -}       [ ['c','o','v','e','r'], ['v','e','i','l'] ],

    TaFaCCaL                  `verb`    {- <tala_t_tam> -}     [ unwords [ ['b','e'], ['c','o','v','e','r','e','d'] ], unwords [ ['b','e'], ['v','e','i','l','e','d'] ] ],

    IFtaCaL                   `verb`    {- <ilta_tam> -}       [ unwords [ ['b','e'], ['c','o','v','e','r','e','d'] ], unwords [ ['b','e'], ['v','e','i','l','e','d'] ] ],

    FaCL |< aT                `noun`    {- <la_tmaT> -}        [ ['k','i','s','s'] ],

    FiCAL                     `noun`    {- <li_tAm> -}         [ ['c','o','v','e','r'], ['v','e','i','l'] ],

    MuFaCCaL                  `adj`     {- <mula_t_tam> -}     [ ['m','a','s','k','e','d'], ['v','e','i','l','e','d'] ],

    MutaFaCCiL                `adj`     {- <mutala_t_tim> -}   [ ['v','e','i','l','e','d'] ] ]
...
cluster_99  = cluster
 ...
 |> "l ^g b" <| [
    ...
    FaCaL                     `noun`    {- <la^gab> -}         [ ['n','o','i','s','e'], ['t','u','m','u','l','t'] ],

    FaCiL                     `adj`     {- <la^gib> -}         [ ['n','o','i','s','y'], ['c','l','a','m','o','r','o','u','s'] ] ]
