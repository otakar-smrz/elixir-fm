...
cluster_37  = cluster
 ...
 |> "_d k r" <| [
    ...
    FiCL                      `noun`    {- <_dikr> -}          [ unwords [ ['d','h','i','k','r'], "(", ['S','u','f','i'], ['r','i','t','u','a','l'], ")" ] ],
    ...
    FiCLY                     `noun`    {- <_dikrY> -}         [ ['c','o','m','m','e','m','o','r','a','t','i','o','n'], ['r','e','m','e','m','b','r','a','n','c','e'], ['m','e','m','o','i','r','s'], ['d','i','a','r','y'] ]
                              `plural`     FiCLY |< At,
    ...
    TaFCiL |< aT              `noun`    {- <ta_dkiraT> -}      [ ['t','i','c','k','e','t'], ['c','a','r','d'] ]
                              `plural`     TaFACiL,

    TaFCaL |< aT              `noun`    {- <ta_dkaraT> -}      [ ['t','i','c','k','e','t'], ['c','a','r','d'] ]
                              `plural`     TaFACiL,

    TaFCaL |< Iy              `noun`    {- <ta_dkarIy> -}      [ unwords [ ['t','i','c','k','e','t'], ['c','l','e','r','k'] ] ]
                              `plural`     TaFCaL |< Iy |< Un
                              `femini`     TaFCaL |< Iy |< aT,

    TaFCaL |<< "^g" |< Iy     `noun`    {- <ta_dkar^gIy> -}    [ unwords [ ['t','i','c','k','e','t'], ['c','l','e','r','k'] ] ]
                              `plural`     TaFCaL |<< "^g" |< Iy |< Un
                              `femini`     TaFCaL |<< "^g" |< Iy |< aT,
...
cluster_41  = cluster
 ...
 |> "_d l q" <| [
    ...
    FawCaL                    `noun`    {- <_dawlaq> -}        [ unwords [ ['t','i','p'], ['o','f'], ['t','h','e'], ['t','o','n','g','u','e'] ] ],

    FawCaL |< Iy              `adj`     {- <_dawlaqIy> -}      [ unwords [ ['a','p','i','c','a','l'], "(", ['w','i','t','h'], ['t','i','p'], ['o','f'], ['t','h','e'], ['t','o','n','g','u','e'], ")" ] ] ]
...
cluster_43  = cluster
 ...
 |> "_d n b" <| [
    ...
    FaCaL                     `noun`    {- <_danab> -}         [ ['t','a','i','l'], ['a','p','p','e','n','d','a','g','e'], ['f','o','l','l','o','w','e','r'], ['d','e','p','e','n','d','e','n','t'] ]
                              `plural`     HaFCAL,
...
cluster_84  = cluster
 ...
 |> "r ^g f" <| [
    ...
    HaFCaL                    `verb`    {- <'ar^gaf> -}        [ unwords [ ['m','a','k','e'], ['t','r','e','m','b','l','e'] ], ['s','h','a','k','e'] ],
...
cluster_89  = cluster
 ...
 |> "r .h r .h" <| [
    ...
    KaRDaS                    `adj`     {- <ra.hra.h> -}       [ ['w','i','d','e'], ['f','l','a','t'], ['c','a','r','e','f','r','e','e'] ]
                              `plural`     KaRDAS ]
...
cluster_92  = cluster
 ...
 |> "r .h l" <| [
    ...
    FaCCAL                    `adj`     {- <ra.h.hAl> -}       [ ['r','o','v','i','n','g'], ['w','a','n','d','e','r','i','n','g'] ]
                              `plural`     FuCCaL
                              `plural`     FaCCAL |< Un,
    ...
    FACiL                     `adj`     {- <rA.hil> -}         [ ['d','e','p','a','r','t','i','n','g'], ['d','e','c','e','a','s','e','d'] ]
                              `plural`     FuCCaL,
...
cluster_93  = cluster
 ...
 |> "r .h m" <| [
    ...
    FaCUL                     `adj`     {- <ra.hUm> -}         [ ['c','o','m','p','a','s','s','i','o','n','a','t','e'] ],
    ...
    FaCLAn                    `noun`    {- <ra.hmAn> -}        [ ['R','a','h','m','a','n'] ],

    FaCLAn                    `adj`     {- <ra.hmAn> -}        [ ['m','e','r','c','i','f','u','l'] ] ]

 |> "r .h m" <| [

    "FaCL_an"                 `noun`    {- <ra.hm_an> -}       [ ['R','a','h','m','a','n'] ],
...
cluster_94  = cluster
 ...
 |> "r _h .s" <| [
    ...
    FaCuL                     `verb`    {- <ra_hu.s> -}        [ unwords [ ['b','e'], ['c','h','e','a','p'] ] ]
                              `imperf`     FCuL
                              `masdar`     FuCL,

    FaCuL                     `verb`    {- <ra_hu.s> -}        [ unwords [ ['b','e'], ['t','e','n','d','e','r'] ] ]
                              `imperf`     FCuL
                              `masdar`     FaCAL |< aT
                              `masdar`     FuCUL |< aT,
    ...
    FaCL                      `adj`     {- <ra_h.s> -}         [ ['s','u','p','p','l','e'], ['s','o','f','t'] ],
...
cluster_98  = cluster
 ...
 |> ['r','U','d','I','s'] <| [
    ...
    _____ |< iyA              `xtra`    {- <rUdIsiyA> -}       [ ['R','h','o','d','e','s','i','a'] ],
